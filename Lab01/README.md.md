...
## Mô tả
Ứng dụng WinForms cho phép nhập và hiển thị thông tin cá nhân gồm: họ tên, năm sinh, giới tính (radio button), khoa (combo box) và email.
...
![Canh bao khi bo trong](screenshots/Canh_bao_khi_chua_nhap_ten.png)

### Cảnh báo khi chưa chọn giới tính
![Canh bao khi chua chon gioi tinh](screenshots/Canh_bao_khi_chua_chon_gioi_tinh.png)

### Cảnh báo khi chưa chọn khoa
![Canh bao khi khong chon khoa](screenshots/Canh_bao_khi_khong_chon_khoa.png)

### Cảnh báo khi năm sinh không hợp lệ
![Nam sinh khong nam trong khoang hop le](screenshots/Nam_sinh_khong_nam_trong_khoang_hop_le.png)

### Cảnh báo khi email sai định dạng
![Email sai dinh dang](screenshots/Email_sai_dinh_dang.png)
